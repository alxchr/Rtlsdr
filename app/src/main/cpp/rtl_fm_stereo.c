 ...
 * Copyright (C) 2012 by Steve Markgraf <st...@steve-m.de>
 * Copyright (C) 2012 by Hoernchen <l...@tfc-server.de>
 * Copyright (C) 2012 by Kyle Keen <keen...@gmail.com>
 * Copyright (C) 2013 by Elias Oenal <eliasoe...@gmail.com>
 *
...
__m128i _mm_slli_epi16 (__m128i a, int imm8) {
	...
	arg1.m128_arg = a;
	for (int i = 0; i < 8;  i++) {
		arg1.array_arg[i] << imm8;
	}
	return arg1.m128_arg;
}
...
__m128i _mm_sub_epi16 (__m128i a, __m128i b) {
	...
	arg_b.m128_arg = b;
	for (int i = 0; i < 8;  i++) {
		arg_a.array_arg[i] = arg_a.array_arg[i] - arg_b.array_arg[i];
	}
	return arg_a.m128_arg;
}
...
__m128i _mm_madd_epi16 (__m128i a, __m128i b) {
	...
	arg_b.m128_arg = b;
	for (int i = 0; i < 3;  i++) {
		res.array_arg[i] = arg_a.array_arg[i*2] * arg_b.array_arg[i*2] +
				arg_a.array_arg[i*2+1] * arg_b.array_arg[i*2+1];
	}
	return res.m128_res;
}
...
float sin2atan2f(int x, int y) {
    /* y = 0 projde bez problÃ©mÅ¯ dÃ¡le */
    if (x == 0) return 0.f;
